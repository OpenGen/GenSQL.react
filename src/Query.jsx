...
SIMILAR TO does not need GENERATE
...
ORDER BY probability_similar DESC
LIMIT 5
# Find 4 developers that are similar to developer 230 in the context of their Python skills and to developer 435 in the context of gender.
SELECT
    ROWID,
    NumPy,
    Python,
